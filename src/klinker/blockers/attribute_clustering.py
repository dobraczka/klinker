...
class TokenClusteringMixin:
    def __init__(
        ...
        **kwargs,
        ...
        self.remove_noise_cluster = remove_noise_cluster
    ...
    def _conc_cluster_labels(
        ...
        res = frame.merge(labels, left_on=frame_col, right_on=val_col)[
            [id_col, frame_col, label_col]
        ]
        # don't know why this is needed
        res.table_name = frame.table_name
        res.id_col = frame.id_col
        return res
    ...
    def embed_and_cluster(
        ...
        if self.remove_noise_cluster:
            val_cluster_label = val_cluster_label[
                val_cluster_label["cluster_label"] > 0
            ]
...
if __name__ == "__main__":
    ...
    blocks = TokenClusteringTokenBlocker().assign(ds.left, ds.right)
